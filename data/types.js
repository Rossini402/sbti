...
// 图片路径映射（远程加载，避免超出小程序 2MB 包大小限制）
const IMG_BASE = 'https://sbti.unun.dev/image'
const TYPE_IMAGES = {
  'IMSB': `${IMG_BASE}/IMSB.png`,
  'BOSS': `${IMG_BASE}/BOSS.png`,
  'MUM': `${IMG_BASE}/MUM.png`,
  'FAKE': `${IMG_BASE}/FAKE.png`,
  'Dior-s': `${IMG_BASE}/Dior-s.jpg`,
  'DEAD': `${IMG_BASE}/DEAD.png`,
  'ZZZZ': `${IMG_BASE}/ZZZZ.png`,
  'GOGO': `${IMG_BASE}/GOGO.png`,
  'FUCK': `${IMG_BASE}/FUCK.png`,
  'CTRL': `${IMG_BASE}/CTRL.png`,
  'HHHH': `${IMG_BASE}/HHHH.png`,
  'SEXY': `${IMG_BASE}/SEXY.png`,
  'OJBK': `${IMG_BASE}/OJBK.png`,
  'JOKE-R': `${IMG_BASE}/JOKE-R.jpg`,
  'POOR': `${IMG_BASE}/POOR.png`,
  'OH-NO': `${IMG_BASE}/OH-NO.png`,
  'MONK': `${IMG_BASE}/MONK.png`,
  'SHIT': `${IMG_BASE}/SHIT.png`,
  'THAN-K': `${IMG_BASE}/THAN-K.png`,
  'MALO': `${IMG_BASE}/MALO.png`,
  'ATM-er': `${IMG_BASE}/ATM-er.png`,
  'THIN-K': `${IMG_BASE}/THIN-K.png`,
  'SOLO': `${IMG_BASE}/SOLO.png`,
  'LOVE-R': `${IMG_BASE}/LOVE-R.png`,
  'WOC!': `${IMG_BASE}/WOC.png`,
  'DRUNK': `${IMG_BASE}/DRUNK.png`,
  'IMFW': `${IMG_BASE}/IMFW.png`
}
...
module.exports = { TYPE_LIBRARY, TYPE_IMAGES, NORMAL_TYPES }
